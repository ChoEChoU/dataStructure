...
Original file is located at
    https://colab.research.google.com/drive/15SMTkQt84cJiwqdxXRvUzPPXfXEml_AB
"""
...
class Graph:
  ...
  def dfs(self):
    ...
    self.nodes[0].set_visited(True)
    print(self.nodes[0].get_data())
    self.dfs_check(self.nodes[0])
    
  
  def dfs_check(self, new_node):
    neighbors = new_node.get_neighbors()
    for neighbor in neighbors:
      if not neighbor.get_visited():
        neighbor.set_visited(True)
        print(neighbor.get_data())
        self.dfs_check(neighbor)
